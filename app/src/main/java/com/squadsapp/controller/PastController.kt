...
class PastController : Fragment() {
    ...
    private lateinit var pastTripView: RecyclerView
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        superView = inflater.inflate(R.layout.fragment_past, container, false)
        pastTripView = superView.findViewById(R.id.handlePastView)
        pastTripView.layoutManager = LinearLayoutManager(tabBarController, LinearLayout.VERTICAL, false)
        return superView
    }
